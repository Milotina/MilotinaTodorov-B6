...
public class BrokenCode {
	...
	public static void main(String[] args) { // should be main

		// we should pass only 2 values here of int type, not double, no need to declare new memory location for void
		addTwoNumbers(2, 4);

		// System.out.println(addResult); //should print result in the void method addTwoNumbers
		...
		whoseFavNumber(23); // should pass only one value
	...
	public static void addTwoNumbers(int numOne, int numTwo) {
		...
		// return result; //no need of return keyword for void methods
